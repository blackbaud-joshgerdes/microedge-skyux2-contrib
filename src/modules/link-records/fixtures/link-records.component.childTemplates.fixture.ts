...
@Component({
  ...
  templateUrl: './link-records.component.childTemplates.fixture.html'
})
export class SkyLinkRecordsChildTemplatesTestComponent {
  ...
  public matches: Observable<Array<LinkRecordsMatchModel>> = Observable.of([
    ...
    new LinkRecordsMatchModel({
      ...
      item: {id: '88', address: 888, name: 'Strawberry Shortcake',
