...
export class SkyContribListToolbarComponent implements OnInit, AfterContentInit {
  ...
  /* tslint:disable */
  @Input('searchText') public searchTextInput: string | Observable<string>;
  /* tslint:enable */

  @ContentChildren(SkyContribListToolbarItemComponent)
    public toolbarItems: QueryList<SkyContribListToolbarItemComponent>;
  @ContentChildren(SkyContribListToolbarSortComponent)
    public toolbarSorts: QueryList<SkyContribListToolbarSortComponent>;
  @ViewChild('search') public searchTemplate: TemplateRef<any>;
  @ViewChild('viewSelector') public viewSelectorTemplate: TemplateRef<any>;
  @ViewChild('sortSelector') public sortSelectorTemplate: TemplateRef<any>;
