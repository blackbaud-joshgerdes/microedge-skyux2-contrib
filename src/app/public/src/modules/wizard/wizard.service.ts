...
import { SkyModalService, SkyModalInstance } from '@blackbaud/skyux/dist/core';
...
export class SkyContribWizardService {
  ...
  public open(
    component: { new(...args: any[]): SaveAndCloseComponent; }, providers: Array<any> = []
  ) {
    let modalInstance: SkyModalInstance = this.modalService.open(<any>component, providers);
