...
describe('Component: SkyContribLinkRecordsItemComponent ', () => {
  let fixture: ComponentFixture<SkyContribLinkRecordsItemComponent>,
    component: SkyContribLinkRecordsItemComponent,
  ...
  beforeEach(async(() => {
    ...
    fixture = TestBed.createComponent(SkyContribLinkRecordsItemComponent);
