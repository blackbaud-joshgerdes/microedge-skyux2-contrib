import {
  Component, Input, TemplateRef, ViewChild,  forwardRef, ChangeDetectionStrategy,
  AfterViewInit
} from '@angular/core';
...
@Component({
  ...
  providers: [
    /* tslint:disable */
    {
      ...
      useExisting: forwardRef(() => SkyContribListViewChecklistComponent)
    },
    /* tslint:enable */
    ChecklistState,
...
export class SkyContribListViewChecklistComponent
  extends ListViewComponent implements AfterViewInit {
  ...
  public itemSelected(id: string) {
    return this.state.map(s => s.selected.item[id] !== undefined);
  }
