...
export class SkyContribListComponent implements AfterContentInit {
  ...
  @Input() public initialSelectedItems: Array<ListItemModel> | Observable<Array<ListItemModel>>;
  @Input()
  ...
  @ContentChildren(ListViewComponent) public listViews: QueryList<ListViewComponent>;
  @ContentChildren(ListPagingComponent) public pagingComponents: QueryList<ListPagingComponent>;
